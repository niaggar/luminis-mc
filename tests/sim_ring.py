...
for time_index in range(spatial_time_detector.N_t):
    ...
    save_file = f"/Users/niaggar/Downloads/right_polarization/intensity_t{time_index:03d}.png"
    ...
    save_file_radial = f"/Users/niaggar/Downloads/right_polarization/radial_intensity_t{time_index:03d}.png"

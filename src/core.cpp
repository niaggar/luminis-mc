...
namespace luminis::core
{
  ...
  // std::vector<double> compute_events_histogram(Sensor &detector, const double min_theta, const double max_theta)
  // {
  ...
  // std::vector<double> compute_theta_histogram(Sensor &detector, const double min_theta, const double max_theta, const int n_bins)
  // {
  //   std::vector<double> histogram(n_bins, 0.0);
  ...
  // std::vector<double> compute_phi_histogram(Sensor &detector, const double min_phi, const double max_phi, const int n_bins)
  // {
  //   std::vector<double> histogram(n_bins, 0.0);
  ...
  // AngularIntensity compute_speckle(Sensor &detector, const int n_theta, const int n_phi)
  // {
  ...
  // SpatialIntensity Sensor::compute_spatial_intensity(const double x_len, const double y_len, const double max_theta, const int n_x, const int n_y) const {
  ...
  // AngularIntensity Sensor::compute_angular_intensity(const double max_theta, const double max_phi, const int n_theta, const int n_phi) const {
  ...
  // std::vector<SpatialIntensity> Sensor::compute_time_resolved_spatial_intensity(const double x_len, const double y_len, const double max_theta, const double t_max, const double dt, const int n_x, const int n_y) const {

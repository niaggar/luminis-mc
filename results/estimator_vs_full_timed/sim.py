...
Compara dos metodos de calculo del cono de retrodispersion coherente (CBS):
    1. Metodo completo (estimator=False): se simulan fotones individuales y se
       suma la contribucion coherente/incoherente del campo lejano.
    2. Metodo del estimador (estimator=True): se calcula la contribucion tras
       cada evento de scattering, requiriendo muchos menos fotones.
...
sweep.log_readme(
    ...
    "with the estimator approach. TIMED."
)

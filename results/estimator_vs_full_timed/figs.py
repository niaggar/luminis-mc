...
# Perfiles CBS: base circular (helicidad), promedio azimutal, ventana temporal 10
prof_est = cbs_profiles(loader_est.processed_cbs("farfield_cbs"), basis=circular, time_index=10)
prof_full = cbs_profiles(loader_full.processed_cbs("farfield_cbs"), basis=circular, time_index=10)

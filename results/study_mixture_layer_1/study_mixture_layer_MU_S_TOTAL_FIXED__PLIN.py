...
# Salida
# ===========================================================================
EXP_NAME = "study_mixture_layer__PLIN__beam2500"
...
# ---------------------------------------------------------------------------
# Polarizacion: LINEAL (m=1, n=0). La etiqueta se deriva del laser -> no puede
# divergir del estado real como pasaba con el string hardcodeado.
# ---------------------------------------------------------------------------
LASER_M = 1
LASER_N = 0
...
RUN_MATCHED_REF = True           # corrida homogenea r2 emparejada -> gate x=0

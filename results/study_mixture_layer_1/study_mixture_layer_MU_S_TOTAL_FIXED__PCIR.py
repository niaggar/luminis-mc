...
# Salida
# ===========================================================================
EXP_NAME = "study_mixture_layer__PCIR"
...
sweep.log_readme(
    ...
    "(r1=0.175 um, r2=0.035 um), polarizacion CIRCULAR (helicidad), estimador. "
...
# ---------------------------------------------------------------------------
# Polarizacion: CIRCULAR (helicidad).  m + i n con |m|^2+|n|^2 = 1.
# ---------------------------------------------------------------------------
LASER_M = 1 / np.sqrt(2)

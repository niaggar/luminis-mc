...
# Salida
# ===========================================================================
EXP_NAME = "study_two_layers_PHI__NORMAL__PLIN__beam2500"
...
#   Familia PHI FIJO: phi_small = phi_large = 0.10. mu_s NO igualado: la
#   GRANDE queda ~11x mas densa opticamente (l_s ~ 10 um vs ~112 um), asi que
#   el contraste de transporte l*_small/l*_large ~ 6 viene de la densidad Y de
#   g, y se INVIERTE respecto a la familia mu_s: ahora el cono ANCHO es el de
#   la GRANDE. Con contraste 6x el cono ESTRECHO (l*_small) ocupa solo q~1/6
...
#   NORMAL -> entra la luz por la particula PEQUEÑA; la GRANDE queda
#             enterrada y semi-infinita.
ORDER = "normal"
RADIUS_TOP, MODEL_TOP = RADIUS_SMALL, MODEL_SMALL
RADIUS_BOT, MODEL_BOT = RADIUS_LARGE, MODEL_LARGE
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# POLARIZACION
#   LINEAL (m=1, n=0). El canal co-polarizado NO esta protegido por
#   reciprocidad: hay dilucion de vertice rho por enrutamiento de simple
#   dispersion, dependiente del tamano. Ademas el perfil NO es azimutalmente
#   simetrico: set_phi_slices([0]) fija UN azimut respecto al campo incidente.
LASER_M = 1.0 + 0.0j
LASER_N = 0.0 + 0.0j
POLARIZATION = "linear"
# ---------------------------------------------------------------------------
...
sweep.log_readme(
    ...
    f"polarizacion {POLARIZATION.upper()} (m=1, n=0), estimador. Una de 8 "

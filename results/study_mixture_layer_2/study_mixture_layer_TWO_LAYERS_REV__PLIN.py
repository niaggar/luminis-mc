...
# Salida
# ===========================================================================
EXP_NAME = "study_two_layers_INV300__PLIN"
...
sweep.log_readme(
    "CBS estratificado INVERSO -- dos capas apiladas (pol. lineal, estimador). "
    "TOP (entra la luz) r=0.075 um = RAPIDA (l* menor); BOT semi-infinita r=0.035 um = LENTA. "
    "Orden de capas invertido respecto a study_two_layers__PLIN para aislar el efecto del "
    "orden. Barrido del espesor de TOP en unidades de l*_top. Rejilla temporal UNICA anclada "
    "a la especie mas lenta (max l*), IDENTICA al experimento normal -> ejes de tiempo "
...
#   Este es el UNICO bloque que difiere del script normal (radios intercambiados).
# ===========================================================================
RADIUS_TOP = 0.075               # um  (rapida, l* menor)
RADIUS_BOT = 0.035               # um  (lenta, l* mayor)
...
# ---------------------------------------------------------------------------
# Grilla temporal (COMPARTIDA por todos los espesores Y por el experimento normal)
...
#   Aqui el TOP es el rapido -> tau*_top pequeno -> M_top grande -> TODAS las interfaces
#   quedan holgadamente dentro de la ventana (la dimensiona el fondo lento).
# ---------------------------------------------------------------------------
